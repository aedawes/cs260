function current(event){
    ...
    const url2= "http://api.openweathermap.org/data/2.5/forecast?q=" + value + ", US&units=metric" + "&APPID=6a55d9d1ec3118d63593d49a27cdde80";
    fetch(url2)
        .then(function(response) {
            return response.json();
        }).then(function(json) {
    ...
    // const url3 = "http://api.openweathermap.org/data/2.5/solar_radiation?q=" + value + ", US&units=metric" + "&APPID=6a55d9d1ec3118d63593d49a27cdde80";
    // fetch(url3)
    //     .then(function(response) {
    //         return response.json();
    //     }).then(function(json) {
