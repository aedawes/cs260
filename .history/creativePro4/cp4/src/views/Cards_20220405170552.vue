                      ...
                      <div class="item" v-for="item in cards" :key="item.firstName">
                        <v-card elevation="5" class="card">
                            ...
                            <v-list-item style="position: absolute; background-color: black;" v-show="clicked" dark elecation="5" class="card" id="editCard">
                                ...
                                <v-list-item-content class="inside">
                                    <v-list-item-title>
                                        <v-text-field v-model="form.firstName" label="firstname"/> <v-text-field v-model="form.lastName" label="lastname"/>
                                    </v-list-item-title>
                                    <v-text-field v-model="form.address" label="123 Peach St"/>
                                    <v-text-field v-model="form.email" label="email@foo.com" required />
                                    <v-text-field v-model="form.phoneNumber" label="(123)456-7890" required />
                                    <v-text-field v-model="form.website" label="www.example.com" required />
                                    <v-btn @click="clicked=!clicked" @click="deleteCard(item)">Delete</v-btn>
                                    <v-btn @click="clicked=!clicked">Edit</v-btn>
                                </v-list-item-content>
                            </v-list-item>
                        </v-card>
