                  ...
                  <div class="grid">
                      <div class="item" v-for="item in cards" :key="item.firstName">
                        <v-card elevation="5" class="card">
                            ...
                            <v-list-item style="position: absolute; background-color: black;" v-show="clicked" dark elecation="5" class="card" id="editCard">
                                <v-list-item-avatar size="200" color="grey"> 
                                    <p id="logo" >{{item.firstName}}{{item.lastName}}</p>
                                </v-list-item-avatar>
                                <v-list-item-content class="inside">
                                    <v-list-item-title>
                                        <v-text-field id="first" v-model="form.firstName" label="firstname"/> <v-text-field id="last" v-model="form.lastName" label="lastname"/>
                                    </v-list-item-title>
                                    <v-text-field id="address" v-model="form.address" label="123 Peach St"/>
                                    <v-text-field id="email" v-model="form.email" label="email@foo.com" required />
                                    <v-text-field id="number" v-model="form.phoneNumber" label="(123)456-7890" required />
                                    <v-text-field id="website" v-model="form.website" label="www.example.com" required />
...
<style scoped>
  ...
  #logo {
    ...
    #first, #last, #address, #email, #number, #website{
        font-size: 0px;
    }
</style>