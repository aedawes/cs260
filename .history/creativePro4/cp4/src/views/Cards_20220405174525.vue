                        ...
                        <v-card elevation="5" class="card">
                            ...
                            <v-list-item v-show="clicked" dark elecation="5" class="card" id="editCard">
                                ...
                                <v-list-item-content class="inside">
                                    ...
                                    <v-text-field class="input" v-model="form.email" label="Email" required />
                                    <v-text-field class="input" v-model="form.phoneNumber" label="Phone Number" required />
                                    <v-text-field class="input" v-model="form.website" label="Website" required />
                                    <p id="spacer"></p>
    ...
    async updateForm(card) {
        try {
          await axios.put("/api/cards/" + card._id, {
            email: this.form.emailfindCard.email,
            phoneNumber: this.form.findCard.phoneNumber,
            website: this.form.findCard.website,
            address: this.form.findCard.address
          });
          this.findCard = null;
          this.getCards();
          return true;
